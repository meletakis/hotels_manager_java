 ...
 * @author bettina
 */
public class UpdateHallReservation extends javax.swing.JFrame {
    ...
    public UpdateHallReservation(Global g , HallReservation HR) {
        this.g = g;
        this.HR= HR;


         dlm = new DefaultListModel();// emfanizei ta diathesima Hall gia kratisi
         int count =0;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update  Reservation for Company");
        ...
        StartDate.setModel(new javax.swing.SpinnerDateModel(new java.util.Date(1273504500000L), new java.util.Date(1273504500000L), new java.util.Date(2220275700000L), java.util.Calendar.DAY_OF_MONTH));
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
         ...
         date_in = (Date) StartDate.getValue();//diabazei ta stoixei apo ton xrhsth
...
//// H ulopoiisi einai paromoia me tis UpdateRoomReservation kai UpdateSuiteReservation
        ...
        try
        {
                         ...
                         if (CompanyN.equals("")  )
                         {
                           CompanyN = HR.getCompanyName();
                         }
                         else if(Fiscal.equals(""))
                         {
                             Fiscal = HR.getCompany_id();
                         }
                            ...
                            if(HR.getCompanyName().equals(""))
                            {
                                JOptionPane.showMessageDialog(this,"UPDATE HALL RESERVATION ERROR\n NO ROOMS");
                            }
                            else
                            {
                                     for( int i=0;i<g.hallReservationsT.size();i++)
                                         if(HR.getCompany_id().equals(g.hallReservationsT.get(i).getCompany_id()) )
                                             g.hallReservationsT.remove(g.hallReservationsT.get(i));// diagrafei tin eggrafi apo ton pinaka


                                     g.hallReservationsT.add(HR);//eisagei to hallreservation me ta kainouria stoixeia ston pinaka!
                                     JOptionPane.showMessageDialog(this,"UPDATE HALLRESERVATION  SUCCESFULL");
                                     this.dispose();
                            }
    ...
    private void NumSeatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NumSeatsActionPerformed
        ...
        String temp = (String)NumSeats.getSelectedItem();
